...
const MyAccount = () => {
  ...
  return (
    <section className="pt-20 min-h-screen flex flex-col">
      <div className="max-w-[1170px] px-5 mx-auto flex-grow">
        {loading && !error && <Loading message="Loading user data..." />}
        {error && !loading && <Error message="Failed to fetch user data. Please try again." />}
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="md:col-span-2 md:px-[30px] pt-20">
              ...
              <div className="flex-grow">
                ...
                {!loading && !error && tab === 'bookings' && <MyBookings />}
                {!loading && !error && tab === 'settings' && <Profile user={userData} />}
              </div>
            </div>
          </div>
        )}
